...
class Autor:
    def __init__(self, nombre="", nacionalidad="", edad=0, cantidadObras=0, vive=False ):        
        self.nombre = nombre
        self.nacionalidad = nacionalidad
        self.edad = edad
        self.cantidadObras = cantidadObras
        

# Crear algunos autores
autor1 = Autor("Mario Benedetti", "Uruguayo", 34, 12, True)
autor2 = Autor("Onetti", "Uruguayo", 56, 22, True)
autor3 = Autor("García Márquez", "Colombiano", 55, 15, True)
